    ...
    <div className="bg-cream">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-12 lg:py-14">
        <aside className="lg:col-span-4" data-aos="fade-right">
          <p className="text-sm font-semibold tracking-wide text-copper">Michigan fishing license</p>
          <h1 className="mt-2 font-display text-3xl text-navy sm:text-4xl">Application</h1>
          <p className="mt-4 leading-relaxed text-ink/75">
            Same official MDNR license. We complete the state portal. You see one total before you pay.
          </p>
          <ul className="mt-6 space-y-3 text-sm text-ink/70">
            ...
            <li className="border-l-2 border-copper pl-3">License emailed after MDNR issues it</li>
          </ul>
          <p className="mt-8 text-xs leading-relaxed text-ink/50">
            ReelPermit is not the Michigan DNR. You can buy the same license on the official eLicense
